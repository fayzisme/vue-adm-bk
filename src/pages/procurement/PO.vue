<template>
	<div id='po-main' class="scrollable only-y">
		...
		<el-card class="mb-10">
			<el-row>
				<el-col :span="3" class="mr-10">
					<el-button @click="dialogAddPo=true" v-if="inRole('superadmin')">
						...
						<el-row>
							<el-col style="display:flex; flex-wrap: wrap;" :span="24">
								<el-input
									...
									:placeholder="`Search`"
									clearable
									@keypress.native="doSearchPO"
									@clear="doSearchPO"
									@keyup.native.delete="doSearchPO"
									v-model="searchPO"
								></el-input>
								<el-select style="flex-basis: 120px" @change="doSearchPO" placeholder="Filter by" v-model="searchBy">
									<el-option
					...
					<el-col :span="12">
						<el-row>
							...
							<el-col :span="16">
								...
								:picker-options="pickerOptions" format="yyyy/MM/dd" style="width: 100%; cursor: pointer;" @change="doSearchPO()"></el-date-picker>
							</el-col>
						</el-row>
					</el-col>
					<!--<el-col :span="3">
		...
		<el-card v-loading="loadingPo">
			...
			<el-button style="width: 150px; height: 40px; float: left;" :loading='loadingDownload' class="animated fadeInRight" type="primary" small @click="download">
				<i class="mdi mdi-download"></i> Download
			</el-button>
		...
		<el-dialog @close="clearForm" :visible.sync="dialogAddPo" title="Tambah PO" :close-on-click-modal="false" :close-on-press-escape="false">
			<el-form :model="form">
		    ...
		    <!-- <el-form-item label="Metode Pengadaan" :label-width="formLabelWidth">
		      <el-input v-model="form.metode_pengadaan" auto-complete="off"></el-input>
				...
				<el-form-item>
					<div>Penyedia</div>
	        <el-select filterable v-model="form.penyedia" style="width:100%" @change="getEmail">
	          <el-option label="Pilih penyedia" value=""></el-option>
	          <el-option v-for="item in penyedia" :key="item.id" :label="item.nama" :value="item.nama">
			  	<span style="float: left">{{ item.nama }}</span>
			...
			<el-form-item>
				...
				<el-select filterable v-model="form.ppn" style="width:100%">
			...
			<el-form-item label="No BA" :label-width="formLabelWidth">
				<!-- <div style="margin: 40px 0 0">
					<el-switch
					v-model="selectSumberBAE"
					active-color="#13ce66"
					inactive-color="#333"
					active-text="Input Manual"
					inactive-text="Pilih dari daftar">
				</el-switch>
				</div> -->
				<!-- <el-input placeholder="Masukkan No BA" v-if="selectSumberBAE==true" v-model="form.no_ba" auto-complete="off" type="text"></el-input>
			  	<el-select v-else filterable v-model="form.no_ba" style="width:100%" placeholder="Pilih nomor BA" @change="autogetloi">
					<el-option v-for="item in listBAE" :key="item.baNumber" :label="item.baNumber" :value="item.baNumber"></el-option>
				</el-select> -->
				<el-autocomplete
						class="auto-input"
						v-model="form.no_ba"
			...
			<el-form-item label="No LOI" :label-width="formLabelWidth">
			  ...
			  <!-- <div style="margin: 40px 0 0">
				...
				<el-input placeholder="Masukkan No LOI" v-if="selectSumberLOI==true" v-model="form.no_loi" auto-complete="off" type="text"></el-input>
			  	<el-select v-else filterable v-model="form.no_loi" style="width:100%" placeholder="Pilih nomor LOI">
					<el-option v-for="item in listBAE" :key="item.loiNumber" :label="item.loiNumber" :value="item.loiNumber"></el-option>
				</el-select> -->
				<el-autocomplete
						class="auto-input"
						ref="noLoi"
		    ...
		    <el-form-item label="Selesai Pekerjaan" :label-width="formLabelWidth">
			  ...
			  <el-date-picker placeholder="Pilih Tanggal" v-model="form.selesai_pekerjaan" format="dd/MM/yyyy" readonly style="width: 100%; cursor: pointer;"/>
		    </el-form-item>
